...
if(reseniasData.comentarios.length > 0){
    ...
    parrafoPrincipal.innerHTML = `Se muestran ${reseniasData.comentarios.length} reseñas con un total de  <b id="promedio">${(reseniasData.likes + reseniasData.dislikes )/ 2}</b> ${(reseniasData.likes + reseniasData.dislikes )/ 2 > 50 ? '<b id="positivos">"Muy Positivos"</b>' : '<b id="negativos">"Muy Negativos"</b>'}`
