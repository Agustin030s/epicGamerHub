...
if(juegosIniciales.length === 0){
  ...
  let rd2 = new Juego(
    ...
    new RequisitosDelSistema("Windows 10 - April 2018 Update (v1803)","Intel® Core™ i7-4770K / AMD Ryzen 5 1500X","16GB de RAM","Nvidia GeForce GTX 1060 6GB / AMD Radeon RX 480 4GB","240GB"),
    new RequisitosDelSistema("Windows 10 - April 2018 Update (v1803)","Intel® Core™ i7-4770K / AMD Ryzen 5 1500X","16GB de RAM","Nvidia GeForce GTX 1060 6GB / AMD Radeon RX 480 4GB","240GB"),
    "Rockstar Games"
  )
  ...
  let cyberPunk2077 = new Juego(
    ...
    new RequisitosDelSistema("64-bit Windows 10","Core i7-12700 or Ryzen 7 7800X3D","16GB de RAM","GeForce RTX 2060 SUPER or Radeon RX 5700 XT or Arc A770","80GB"),
    new RequisitosDelSistema("64-bit Windows 10","Core i7-6700 or Ryzen 5 1600","16GB de RAM","GeForce GTX 1060 6GB or Radeon RX 580 8GB or Arc A380","80GB"),
    "CD PROJEKT RED"
  )
  ...
  let rs4 = new Juego(
    ...
    new RequisitosDelSistema("Windows 10 (64 bit)/Windows 11 (64 bit)","AMD Ryzen 5 3600 / Intel Core i7 8700","16GB de RAM","AMD Radeon RX 5700 / NVIDIA GeForce GTX 1070","128GB"),
    new RequisitosDelSistema("Windows 10 (64 bit)","AMD Ryzen 3 1200 / Intel Core i5-7500","16GB de RAM","AMD Radeon RX 560 with 4GB VRAM / NVIDIA GeForce GTX 1050 Ti with 4GB VRAM","128GB"),
    "CAPCOM"
  )
  ...
  let nba24 = new Juego(
    ...
    new RequisitosDelSistema("Windows 10 64-bit or Windows 11 64-bit","Intel® Core™ i5-4430 @ 3 GHz/ AMD FX-8370 @ 3.4 GHz or better","8GB de RAM","NVIDIA® GeForce® GTX 770 2GB/ ATI® Radeon™ R9 270 2GB or better","240GB"),
    new RequisitosDelSistema("Windows 10 64-bit or Windows 11 64-bit","Intel® Core™ i3-2100 @ 3.10 GHz/ AMD FX-6200 @ 3.80 GHz or better","8GB de RAM","NVIDIA® GeForce® GT 450 1GB/ ATI® Radeon™ HD 7770 1 GB or better","240GB"),
    "Visual Concepts 2K"
  )
  ...
  let arkAscended = new Juego(
    ...
    new RequisitosDelSistema("Windows 10/11 with updates","AMD Ryzen 5 3600X, Intel i5-10600K","32GB de RAM","AMD Radeon RX 6800, NVIDIA GeForce RTX 3080","80GB"),
    new RequisitosDelSistema("Windows 10/11 with updates","AMD Ryzen 5 2600X, Intel Core i7-6800K","16GB de RAM","AMD Radeon RX 5600 XT, NVIDIA GeForce 1080","80GB"),
    "Studio Wilcard"
  )
  ...
  let eldenRing = new Juego(
    ...
    new RequisitosDelSistema("Windows 10/11","INTEL CORE I7-8700K or AMD RYZEN 5 3600X","16GB de RAM","NVIDIA GEFORCE GTX 1070 8 GB or AMD RADEON RX VEGA 56 8 GB","80GB"),
    new RequisitosDelSistema("Windows 10","INTEL CORE I5-8400 or AMD RYZEN 3 3300X","16GB de RAM","NVIDIA GEFORCE GTX 1060 3 GB or AMD RADEON RX 580 4 GB","80GB"),
    "FromSoftware"
  )
  ...
  let theLastOfUsP1 = new Juego(
    ...
    new RequisitosDelSistema("Windows 10 (Version 1909 or Newer)","AMD Ryzen 5 3600X, Intel Core i7-8700","16GB de RAM","AMD Radeon RX 5700 XT (8 GB), AMD Radeon RX 6600 XT (8 GB), NVIDIA GeForce RTX 2070 SUPER (8 GB), NVIDIA GeForce RTX 3060 (8 GB)","128GB"),
    new RequisitosDelSistema("Windows 10 (Version 1909 or Newer)","AMD Ryzen 5 1500X, Intel Core i7-4770K","16GB de RAM","AMD Radeon RX 470 (4 GB), AMD Radeon RX 6500 XT (4 GB), NVIDIA GeForce GTX 970 (4 GB), NVIDIA GeForce GTX 1050 Ti (4 GB)","128GB"),
    "Naughty Dog LLC"
  )
  ...
  let farCry6 = new Juego(
    ...
    new RequisitosDelSistema("Windows 10 (20H1 version or newer, 64-bit versions)","AMD Ryzen 5 3600X @ 3.8 GHz or Intel Core i7-7700 @ 3.6 GHz (AVX, AVX2 and SSE 4.2 support required)","16GB de RAM","AMD RX Vega 64 (8 GB) or NVIDIA GeForce GTX 1080 (8 GB)","240GB"),
    new RequisitosDelSistema("Windows 10 (20H1 version or newer, 64-bit versions)","AMD Ryzen 3 1200 @ 3. GHz or Intel Core i5-4460 @ 3.1 GHz (AVX, AVX2 and SSE 4.2 support required)","8GB de RAM","AMD RX 460 (4 GB) or NVIDIA GeForce GTX 960 (4 GB)","240GB"),
    "Ubisoft"
  )
  ...
  let fh5 = new Juego(
    ...
    new RequisitosDelSistema("Windows 10 version 18362.0 or higher","Intel i5-8400 or AMD Ryzen 5 1500X","16 GB de RAM","NVidia GTX 1070 OR AMD RX 590","128GB"),
    new RequisitosDelSistema("Windows 10 version 18362.0 or higher","Intel i5-4460 or AMD Ryzen 3 1200","8 GB de RAM","NVidia GTX 970 OR AMD RX 470","128GB"),
    "PlayGround Games"
  )
